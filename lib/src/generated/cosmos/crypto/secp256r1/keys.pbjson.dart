...
final $typed_data.Uint8List pubKeyDescriptor =
    $convert.base64Decode('CgZQdWJLZXkSHQoDa2V5GAEgASgMQgva3h8HZWNkc2FQS1IDa2V5');
...
final $typed_data.Uint8List privKeyDescriptor =
    $convert.base64Decode('CgdQcml2S2V5EiMKBnNlY3JldBgBIAEoDEIL2t4fB2VjZHNhU0tSBnNlY3JldA==');
