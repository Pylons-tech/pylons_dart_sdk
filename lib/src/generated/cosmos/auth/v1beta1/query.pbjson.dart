...
const $core.Map<$core.String, $core.dynamic> QueryServiceBase$json = const {
  ...
  '2': const [
    const {
      '1': 'Accounts',
      '2': '.cosmos.auth.v1beta1.QueryAccountsRequest',
      '3': '.cosmos.auth.v1beta1.QueryAccountsResponse',
      '4': const {}
    },
    const {
      '1': 'Account',
      '2': '.cosmos.auth.v1beta1.QueryAccountRequest',
      '3': '.cosmos.auth.v1beta1.QueryAccountResponse',
      '4': const {}
    },
    const {
      '1': 'Params',
      '2': '.cosmos.auth.v1beta1.QueryParamsRequest',
      '3': '.cosmos.auth.v1beta1.QueryParamsResponse',
      '4': const {}
    },
  ],
};
...
const $core.Map<$core.String, $core.Map<$core.String, $core.dynamic>> QueryServiceBase$messageJson = const {
  ...
  '.cosmos.auth.v1beta1.Params': $1.Params$json,
};
...
final $typed_data.Uint8List queryServiceDescriptor = $convert.base64Decode(
    '');
