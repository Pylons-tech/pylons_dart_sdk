...
abstract class QueryServiceBase extends $pb.GeneratedService {
  ...
  $pb.GeneratedMessage createRequest($core.String method) {
    switch (method) {
      case 'Accounts': return $3.QueryAccountsRequest();
      case 'Account': return $3.QueryAccountRequest();
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      case 'Accounts': return this.accounts(ctx, request as $3.QueryAccountsRequest);
      case 'Account': return this.account(ctx, request as $3.QueryAccountRequest);
