...
class GenesisState extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(
    ...
    ..pc<$4.Cookbook>(
        1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'cookbookList', $pb.PbFieldType.PM,
        protoName: 'cookbookList', subBuilder: $4.Cookbook.create)
    ..pc<$2.Recipe>(
        2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'recipeList', $pb.PbFieldType.PM,
        protoName: 'recipeList', subBuilder: $2.Recipe.create)
    ..pc<$1.Item>(
        3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemList', $pb.PbFieldType.PM,
        protoName: 'itemList', subBuilder: $1.Item.create)
    ..a<$fixnum.Int64>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pendingExecutionCount',
        $pb.PbFieldType.OU6,
        protoName: 'pendingExecutionCount', defaultOrMaker: $fixnum.Int64.ZERO)
    ..pc<$7.Execution>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'pendingExecutionList',
        $pb.PbFieldType.PM,
        protoName: 'pendingExecutionList', subBuilder: $7.Execution.create)
    ..a<$fixnum.Int64>(
        6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionCount', $pb.PbFieldType.OU6,
        protoName: 'executionCount', defaultOrMaker: $fixnum.Int64.ZERO)
    ..pc<$7.Execution>(
        7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'executionList', $pb.PbFieldType.PM,
        protoName: 'executionList', subBuilder: $7.Execution.create)
    ..pc<$8.GoogleInAppPurchaseOrder>(
        8,
        const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'googleInAppPurchaseOrderList',
        $pb.PbFieldType.PM,
        protoName: 'googleInAppPurchaseOrderList',
        subBuilder: $8.GoogleInAppPurchaseOrder.create)
    ..a<$fixnum.Int64>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'googleIAPOrderCount',
        $pb.PbFieldType.OU6,
        protoName: 'googleIAPOrderCount', defaultOrMaker: $fixnum.Int64.ZERO)
    ..aOM<$9.Params>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'params',
        subBuilder: $9.Params.create)
    ..a<$fixnum.Int64>(
        11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entityCount', $pb.PbFieldType.OU6,
        protoName: 'entityCount', defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(
        12, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tradeCount', $pb.PbFieldType.OU6,
        protoName: 'tradeCount', defaultOrMaker: $fixnum.Int64.ZERO)
    ..pc<$6.Trade>(
        13, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'tradeList', $pb.PbFieldType.PM,
        protoName: 'tradeList', subBuilder: $6.Trade.create)
    ..pc<$10.UserMap>(
        14, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'accountList', $pb.PbFieldType.PM,
        protoName: 'accountList', subBuilder: $10.UserMap.create)
    ..pc<$5.PaymentInfo>(
        15, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentInfoList', $pb.PbFieldType.PM,
        protoName: 'paymentInfoList', subBuilder: $5.PaymentInfo.create)
    ..pc<$3.RedeemInfo>(
        16, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'redeemInfoList', $pb.PbFieldType.PM,
        protoName: 'redeemInfoList', subBuilder: $3.RedeemInfo.create)
    ..hasRequiredFields = false;

  GenesisState._() : super();
  factory GenesisState({
    $core.Iterable<$4.Cookbook>? cookbookList,
    $core.Iterable<$2.Recipe>? recipeList,
    $core.Iterable<$1.Item>? itemList,
    ...
    $core.Iterable<$5.PaymentInfo>? paymentInfoList,
    $core.Iterable<$3.RedeemInfo>? redeemInfoList,
  }) {
  ...
  @$pb.TagNumber(1)
  $core.List<$4.Cookbook> get cookbookList => $_getList(0);

  @$pb.TagNumber(2)
  $core.List<$2.Recipe> get recipeList => $_getList(1);

  @$pb.TagNumber(3)
  $core.List<$1.Item> get itemList => $_getList(2);
  ...
  @$pb.TagNumber(15)
  $core.List<$5.PaymentInfo> get paymentInfoList => $_getList(14);
