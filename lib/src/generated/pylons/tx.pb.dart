...
class MsgBurnDebtToken extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgBurnDebtToken', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ...
    ..aOM<$3.RedeemInfo>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'redeemInfo', protoName: 'redeemInfo', subBuilder: $3.RedeemInfo.create)
  ...
  @$pb.TagNumber(2)
  set redeemInfo($3.RedeemInfo v) { setField(2, v); }
  @$pb.TagNumber(2)
...
class MsgFulfillTrade extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgFulfillTrade', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ...
    ..pc<$5.PaymentInfo>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentInfos', $pb.PbFieldType.PM, protoName: 'paymentInfos', subBuilder: $5.PaymentInfo.create)
    ..hasRequiredFields = false
  ;
...
class MsgCreateTrade extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgCreateTrade', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creator')
    ..pc<$2.CoinInput>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coinInputs', $pb.PbFieldType.PM, protoName: 'coinInputs', subBuilder: $2.CoinInput.create)
    ..pc<$2.ItemInput>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemInputs', $pb.PbFieldType.PM, protoName: 'itemInputs', subBuilder: $2.ItemInput.create)
    ..pc<$0.Coin>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coinOutputs', $pb.PbFieldType.PM, protoName: 'coinOutputs', subBuilder: $0.Coin.create)
...
class MsgExecuteRecipe extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgExecuteRecipe', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ...
    ..pc<$5.PaymentInfo>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentInfos', $pb.PbFieldType.PM, protoName: 'paymentInfos', subBuilder: $5.PaymentInfo.create)
    ..hasRequiredFields = false
  ;
...
class MsgCreateRecipe extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgCreateRecipe', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ...
    ..pc<$2.CoinInput>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coinInputs', $pb.PbFieldType.PM, protoName: 'coinInputs', subBuilder: $2.CoinInput.create)
    ..pc<$2.ItemInput>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemInputs', $pb.PbFieldType.PM, protoName: 'itemInputs', subBuilder: $2.ItemInput.create)
    ..aOM<$2.EntriesList>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entries', subBuilder: $2.EntriesList.create)
    ..pc<$2.WeightedOutputs>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'outputs', $pb.PbFieldType.PM, subBuilder: $2.WeightedOutputs.create)
  ...
  @$pb.TagNumber(9)
  set entries($2.EntriesList v) { setField(9, v); }
  @$pb.TagNumber(9)
...
class MsgCreateCookbook extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'MsgCreateCookbook', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ...
    ..aOM<$0.Coin>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'costPerBlock', protoName: 'costPerBlock', subBuilder: $0.Coin.create)
  ...
  @$pb.TagNumber(8)
  set costPerBlock($0.Coin v) { setField(8, v); }
  @$pb.TagNumber(8)
...
class MsgApi {
  ...
  $async.Future<MsgBurnDebtTokenResponse> burnDebtToken($pb.ClientContext? ctx, MsgBurnDebtToken request) {
    var emptyResponse = MsgBurnDebtTokenResponse();
    return _client.invoke<MsgBurnDebtTokenResponse>(ctx, 'Msg', 'BurnDebtToken', request, emptyResponse);
  }
  $async.Future<MsgUpdateAccountResponse> updateAccount($pb.ClientContext? ctx, MsgUpdateAccount request) {
    var emptyResponse = MsgUpdateAccountResponse();
    return _client.invoke<MsgUpdateAccountResponse>(ctx, 'Msg', 'UpdateAccount', request, emptyResponse);
  }
  $async.Future<MsgFulfillTradeResponse> fulfillTrade($pb.ClientContext? ctx, MsgFulfillTrade request) {
    var emptyResponse = MsgFulfillTradeResponse();
    return _client.invoke<MsgFulfillTradeResponse>(ctx, 'Msg', 'FulfillTrade', request, emptyResponse);
  }
  $async.Future<MsgCreateTradeResponse> createTrade($pb.ClientContext? ctx, MsgCreateTrade request) {
    var emptyResponse = MsgCreateTradeResponse();
    return _client.invoke<MsgCreateTradeResponse>(ctx, 'Msg', 'CreateTrade', request, emptyResponse);
  }
  $async.Future<MsgCancelTradeResponse> cancelTrade($pb.ClientContext? ctx, MsgCancelTrade request) {
    var emptyResponse = MsgCancelTradeResponse();
    return _client.invoke<MsgCancelTradeResponse>(ctx, 'Msg', 'CancelTrade', request, emptyResponse);
  }
  $async.Future<MsgCompleteExecutionEarlyResponse> completeExecutionEarly($pb.ClientContext? ctx, MsgCompleteExecutionEarly request) {
    var emptyResponse = MsgCompleteExecutionEarlyResponse();
    return _client.invoke<MsgCompleteExecutionEarlyResponse>(ctx, 'Msg', 'CompleteExecutionEarly', request, emptyResponse);
  }
  $async.Future<MsgTransferCookbookResponse> transferCookbook($pb.ClientContext? ctx, MsgTransferCookbook request) {
    var emptyResponse = MsgTransferCookbookResponse();
    return _client.invoke<MsgTransferCookbookResponse>(ctx, 'Msg', 'TransferCookbook', request, emptyResponse);
  }
  $async.Future<MsgGoogleInAppPurchaseGetCoinsResponse> googleInAppPurchaseGetCoins($pb.ClientContext? ctx, MsgGoogleInAppPurchaseGetCoins request) {
    var emptyResponse = MsgGoogleInAppPurchaseGetCoinsResponse();
    return _client.invoke<MsgGoogleInAppPurchaseGetCoinsResponse>(ctx, 'Msg', 'GoogleInAppPurchaseGetCoins', request, emptyResponse);
  }
  $async.Future<MsgCreateAccountResponse> createAccount($pb.ClientContext? ctx, MsgCreateAccount request) {
    var emptyResponse = MsgCreateAccountResponse();
    return _client.invoke<MsgCreateAccountResponse>(ctx, 'Msg', 'CreateAccount', request, emptyResponse);
  }
  $async.Future<MsgSendItemsResponse> sendItems($pb.ClientContext? ctx, MsgSendItems request) {
    var emptyResponse = MsgSendItemsResponse();
    return _client.invoke<MsgSendItemsResponse>(ctx, 'Msg', 'SendItems', request, emptyResponse);
  }
  $async.Future<MsgExecuteRecipeResponse> executeRecipe($pb.ClientContext? ctx, MsgExecuteRecipe request) {
    var emptyResponse = MsgExecuteRecipeResponse();
    return _client.invoke<MsgExecuteRecipeResponse>(ctx, 'Msg', 'ExecuteRecipe', request, emptyResponse);
  }
  $async.Future<MsgSetItemStringResponse> setItemString($pb.ClientContext? ctx, MsgSetItemString request) {
    var emptyResponse = MsgSetItemStringResponse();
    return _client.invoke<MsgSetItemStringResponse>(ctx, 'Msg', 'SetItemString', request, emptyResponse);
  }
  $async.Future<MsgCreateRecipeResponse> createRecipe($pb.ClientContext? ctx, MsgCreateRecipe request) {
    var emptyResponse = MsgCreateRecipeResponse();
    return _client.invoke<MsgCreateRecipeResponse>(ctx, 'Msg', 'CreateRecipe', request, emptyResponse);
  }
  $async.Future<MsgUpdateRecipeResponse> updateRecipe($pb.ClientContext? ctx, MsgUpdateRecipe request) {
    var emptyResponse = MsgUpdateRecipeResponse();
    return _client.invoke<MsgUpdateRecipeResponse>(ctx, 'Msg', 'UpdateRecipe', request, emptyResponse);
  }
  $async.Future<MsgCreateCookbookResponse> createCookbook($pb.ClientContext? ctx, MsgCreateCookbook request) {
    var emptyResponse = MsgCreateCookbookResponse();
    return _client.invoke<MsgCreateCookbookResponse>(ctx, 'Msg', 'CreateCookbook', request, emptyResponse);
  }
  $async.Future<MsgUpdateCookbookResponse> updateCookbook($pb.ClientContext? ctx, MsgUpdateCookbook request) {
    var emptyResponse = MsgUpdateCookbookResponse();
    return _client.invoke<MsgUpdateCookbookResponse>(ctx, 'Msg', 'UpdateCookbook', request, emptyResponse);
  }
}
