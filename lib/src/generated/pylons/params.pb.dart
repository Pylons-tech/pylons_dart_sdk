...
class Params extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Params', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ...
    ..aOM<$0.Coin>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'UpdateItemStringFee', protoName: 'UpdateItemStringFee', subBuilder: $0.Coin.create)
    ...
    ..aOM<$0.Coin>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'UpdateUsernameFee', protoName: 'UpdateUsernameFee', subBuilder: $0.Coin.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(6)
  $0.Coin get updateItemStringFee => $_getN(5);
  @$pb.TagNumber(6)
  set updateItemStringFee($0.Coin v) { setField(6, v); }
  @$pb.TagNumber(6)
  $core.bool hasUpdateItemStringFee() => $_has(5);
  @$pb.TagNumber(6)
  void clearUpdateItemStringFee() => clearField(6);
  @$pb.TagNumber(6)
  $0.Coin ensureUpdateItemStringFee() => $_ensure(5);
  ...
  @$pb.TagNumber(9)
  $0.Coin get updateUsernameFee => $_getN(8);
  @$pb.TagNumber(9)
  set updateUsernameFee($0.Coin v) { setField(9, v); }
  @$pb.TagNumber(9)
  $core.bool hasUpdateUsernameFee() => $_has(8);
  @$pb.TagNumber(9)
  void clearUpdateUsernameFee() => clearField(9);
  @$pb.TagNumber(9)
  $0.Coin ensureUpdateUsernameFee() => $_ensure(8);
}
