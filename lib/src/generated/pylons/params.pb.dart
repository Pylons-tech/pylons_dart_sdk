...
class CoinIssuer extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'CoinIssuer', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pylons.pylons'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coinDenom')
    ..pc<GoogleInAppPurchasePackage>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'packages', $pb.PbFieldType.PM, subBuilder: GoogleInAppPurchasePackage.create)
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'googleInAppPurchasePubKey')
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'entityName')
    ..hasRequiredFields = false
  ;
...
class PaymentProcessor extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PaymentProcessor', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pylons.pylons'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coinDenom')
  ...
  @$core.pragma('dart2js:noInline')
  static PaymentProcessor getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<PaymentProcessor>(create);
  ...
  @$pb.TagNumber(3)
  set processorPercentage($core.String v) { $_setString(2, v); }
  @$pb.TagNumber(3)
  ...
  @$pb.TagNumber(4)
  set validatorsPercentage($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
...
class Params extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Params', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pylons.pylons'), createEmptyInstance: create)
    ..pc<CoinIssuer>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coinIssuers', $pb.PbFieldType.PM, subBuilder: CoinIssuer.create)
    ..pc<PaymentProcessor>(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'paymentProcessors', $pb.PbFieldType.PM, subBuilder: PaymentProcessor.create)
    ...
    ..aOM<$2.Coin>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateItemStringFee', subBuilder: $2.Coin.create)
    ...
    ..aOM<$2.Coin>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'updateUsernameFee', subBuilder: $2.Coin.create)
    ..aOS(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'distrEpochIdentifier')
    ..a<$fixnum.Int64>(10, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'engineVersion', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..a<$fixnum.Int64>(11, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'maxTxsInBlock', $pb.PbFieldType.OU6, defaultOrMaker: $fixnum.Int64.ZERO)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(11)
  set maxTxsInBlock($fixnum.Int64 v) { $_setInt64(10, v); }
  @$pb.TagNumber(11)
