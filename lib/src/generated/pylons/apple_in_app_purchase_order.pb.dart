...
class AppleInAppPurchaseOrder extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'AppleInAppPurchaseOrder', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'pylons.pylons'), createEmptyInstance: create)
    ...
    ..aOS(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'purchaseDate')
    ..aOS(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creator')
  ...
  factory AppleInAppPurchaseOrder.fromBuffer($core.List<$core.int> i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromBuffer(i, r);
  factory AppleInAppPurchaseOrder.fromJson($core.String i, [$pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY]) => create()..mergeFromJson(i, r);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.deepCopy] instead. '
  'Will be removed in next major version')
  AppleInAppPurchaseOrder clone() => AppleInAppPurchaseOrder()..mergeFromMessage(this);
  @$core.Deprecated(
  'Using this can add significant overhead to your binary. '
  'Use [GeneratedMessageGenericExtensions.rebuild] instead. '
  'Will be removed in next major version')
  AppleInAppPurchaseOrder copyWith(void Function(AppleInAppPurchaseOrder) updates) => super.copyWith((message) => updates(message as AppleInAppPurchaseOrder)) as AppleInAppPurchaseOrder; // ignore: deprecated_member_use
  ...
  static $pb.PbList<AppleInAppPurchaseOrder> createRepeated() => $pb.PbList<AppleInAppPurchaseOrder>();
  @$core.pragma('dart2js:noInline')
  static AppleInAppPurchaseOrder getDefault() => _defaultInstance ??= $pb.GeneratedMessage.$_defaultFor<AppleInAppPurchaseOrder>(create);
  ...
  @$pb.TagNumber(4)
  set purchaseDate($core.String v) { $_setString(3, v); }
  @$pb.TagNumber(4)
