...
final $typed_data.Uint8List doubleInputParamDescriptor = $convert.base64Decode(
    'ChBEb3VibGVJbnB1dFBhcmFtEhAKA2tleRgBIAEoCVIDa2V5EkoKCG1pblZhbHVlGAIgASgJQi7I3h8A2t4fJmdpdGh1Yi5jb20vY29zbW9zL2Nvc21vcy1zZGsvdHlwZXMuRGVjUghtaW5WYWx1ZRJKCghtYXhWYWx1ZRgDIAEoCUIuyN4fANreHyZnaXRodWIuY29tL2Nvc21vcy9jb3Ntb3Mtc2RrL3R5cGVzLkRlY1IIbWF4VmFsdWU=');
...
final $typed_data.Uint8List longInputParamDescriptor = $convert.base64Decode(
    'Cg5Mb25nSW5wdXRQYXJhbRIQCgNrZXkYASABKAlSA2tleRIaCghtaW5WYWx1ZRgCIAEoA1IIbWluVmFsdWUSGgoIbWF4VmFsdWUYAyABKANSCG1heFZhbHVl');
...
final $typed_data.Uint8List conditionListDescriptor = $convert.base64Decode(
    '');
...
const ItemInput$json = const {
  ...
  '2': const [
    ...
    const {
      ...
      '4': 1,
      '5': 11,
      '6': '.Pylonstech.pylons.pylons.ConditionList',
      '8': const {},
      '10': 'conditions'
    },
  ],
...
final $typed_data.Uint8List itemInputDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List doubleWeightRangeDescriptor = $convert.base64Decode(
    'ChFEb3VibGVXZWlnaHRSYW5nZRJECgVsb3dlchgBIAEoCUIuyN4fANreHyZnaXRodWIuY29tL2Nvc21vcy9jb3Ntb3Mtc2RrL3R5cGVzLkRlY1IFbG93ZXISRAoFdXBwZXIYAiABKAlCLsjeHwDa3h8mZ2l0aHViLmNvbS9jb3Ntb3MvY29zbW9zLXNkay90eXBlcy5EZWNSBXVwcGVyEhYKBndlaWdodBgDIAEoBFIGd2VpZ2h0');
...
final $typed_data.Uint8List doubleParamDescriptor = $convert.base64Decode(
    'CgtEb3VibGVQYXJhbRIQCgNrZXkYASABKAlSA2tleRJVCgx3ZWlnaHRSYW5nZXMYAiADKAsyKy5QeWxvbnN0ZWNoLnB5bG9ucy5weWxvbnMuRG91YmxlV2VpZ2h0UmFuZ2VCBMjeHwBSDHdlaWdodFJhbmdlcxIYCgdwcm9ncmFtGAMgASgJUgdwcm9ncmFt');
...
final $typed_data.Uint8List intWeightRangeDescriptor = $convert.base64Decode(
    'Cg5JbnRXZWlnaHRSYW5nZRIUCgVsb3dlchgBIAEoA1IFbG93ZXISFAoFdXBwZXIYAiABKANSBXVwcGVyEhYKBndlaWdodBgDIAEoBFIGd2VpZ2h0');
...
final $typed_data.Uint8List longParamDescriptor = $convert.base64Decode(
    'CglMb25nUGFyYW0SEAoDa2V5GAEgASgJUgNrZXkSUgoMd2VpZ2h0UmFuZ2VzGAIgAygLMiguUHlsb25zdGVjaC5weWxvbnMucHlsb25zLkludFdlaWdodFJhbmdlQgTI3h8AUgx3ZWlnaHRSYW5nZXMSGAoHcHJvZ3JhbRgDIAEoCVIHcHJvZ3JhbQ==');
...
final $typed_data.Uint8List coinOutputDescriptor = $convert.base64Decode(
    'CgpDb2luT3V0cHV0Eg4KAklEGAEgASgJUgJJRBIzCgRjb2luGAIgASgLMhkuY29zbW9zLmJhc2UudjFiZXRhMS5Db2luQgTI3h8AUgRjb2luEhgKB3Byb2dyYW0YAyABKAlSB3Byb2dyYW0=');
...
final $typed_data.Uint8List itemOutputDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List itemModifyOutputDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List entriesListDescriptor = $convert.base64Decode(
    '');
...
final $typed_data.Uint8List weightedOutputsDescriptor = $convert.base64Decode(
    'Cg9XZWlnaHRlZE91dHB1dHMSIAoIZW50cnlJRHMYASADKAlCBMjeHwBSCGVudHJ5SURzEhYKBndlaWdodBgCIAEoBFIGd2VpZ2h0');
...
final $typed_data.Uint8List recipeDescriptor = $convert.base64Decode(
    '');
