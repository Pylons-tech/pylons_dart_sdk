...
const QueryListTradesByCreatorResponse$json = const {
  ...
  '2': const [
    const {'1': 'trades', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.Trade', '8': const {}, '10': 'trades'},
...
final $typed_data.Uint8List queryListTradesByCreatorResponseDescriptor = $convert.base64Decode('CiBRdWVyeUxpc3RUcmFkZXNCeUNyZWF0b3JSZXNwb25zZRIyCgZ0cmFkZXMYASADKAsyFC5weWxvbnMucHlsb25zLlRyYWRlQgTI3h8AUgZ0cmFkZXMSRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9uOgjooB8AiKAfAA==');
@$core.Deprecated('Use queryGetRecipeHistoryRequestDescriptor instead')
const QueryGetRecipeHistoryRequest$json = const {
  '1': 'QueryGetRecipeHistoryRequest',
  '2': const [
    const {'1': 'cookbook_id', '3': 1, '4': 1, '5': 9, '10': 'cookbookId'},
    const {'1': 'recipe_id', '3': 2, '4': 1, '5': 9, '10': 'recipeId'},
  ],
};

/// Descriptor for `QueryGetRecipeHistoryRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetRecipeHistoryRequestDescriptor = $convert.base64Decode('ChxRdWVyeUdldFJlY2lwZUhpc3RvcnlSZXF1ZXN0Eh8KC2Nvb2tib29rX2lkGAEgASgJUgpjb29rYm9va0lkEhsKCXJlY2lwZV9pZBgCIAEoCVIIcmVjaXBlSWQ=');
@$core.Deprecated('Use queryGetRecipeHistoryResponseDescriptor instead')
const QueryGetRecipeHistoryResponse$json = const {
  '1': 'QueryGetRecipeHistoryResponse',
  '2': const [
    const {'1': 'history', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.RecipeHistory', '10': 'history'},
  ],
};
...
const RecipeHistory$json = const {
  ...
  '2': const [
    ...
    const {'1': 'sender_name', '3': 5, '4': 1, '5': 9, '10': 'senderName'},
    const {'1': 'receiver', '3': 6, '4': 1, '5': 9, '10': 'receiver'},
    const {'1': 'amount', '3': 7, '4': 1, '5': 9, '10': 'amount'},
    const {'1': 'created_at', '3': 8, '4': 1, '5': 3, '10': 'createdAt'},
  ],
};

/// Descriptor for `RecipeHistory`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List recipeHistoryDescriptor = $convert.base64Decode('');
@$core.Deprecated('Use queryGetStripeRefundRequestDescriptor instead')
const QueryGetStripeRefundRequest$json = const {
  '1': 'QueryGetStripeRefundRequest',
};

/// Descriptor for `QueryGetStripeRefundRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetStripeRefundRequestDescriptor = $convert.base64Decode('ChtRdWVyeUdldFN0cmlwZVJlZnVuZFJlcXVlc3Q=');
@$core.Deprecated('Use queryGetStripeRefundResponseDescriptor instead')
const QueryGetStripeRefundResponse$json = const {
  '1': 'QueryGetStripeRefundResponse',
  '2': const [
    const {'1': 'refunds', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.StripeRefund', '10': 'refunds'},
  ],
};

/// Descriptor for `QueryGetStripeRefundResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetStripeRefundResponseDescriptor = $convert.base64Decode('ChxRdWVyeUdldFN0cmlwZVJlZnVuZFJlc3BvbnNlEjUKB3JlZnVuZHMYASADKAsyGy5weWxvbnMucHlsb25zLlN0cmlwZVJlZnVuZFIHcmVmdW5kcw==');
...
final $typed_data.Uint8List queryGetRedeemInfoRequestDescriptor = $convert.base64Decode('ChlRdWVyeUdldFJlZGVlbUluZm9SZXF1ZXN0Eg4KAmlkGAEgASgJUgJpZA==');
...
const QueryGetRedeemInfoResponse$json = const {
  ...
  '2': const [
    const {'1': 'redeem_info', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.RedeemInfo', '8': const {}, '10': 'redeemInfo'},
  ],
};

/// Descriptor for `QueryGetRedeemInfoResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetRedeemInfoResponseDescriptor = $convert.base64Decode('ChpRdWVyeUdldFJlZGVlbUluZm9SZXNwb25zZRJACgtyZWRlZW1faW5mbxgBIAEoCzIZLnB5bG9ucy5weWxvbnMuUmVkZWVtSW5mb0IEyN4fAFIKcmVkZWVtSW5mbw==');
...
const QueryAllRedeemInfoResponse$json = const {
  ...
  '2': const [
    const {'1': 'redeem_info', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.RedeemInfo', '8': const {}, '10': 'redeemInfo'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryAllRedeemInfoResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAllRedeemInfoResponseDescriptor = $convert.base64Decode('ChpRdWVyeUFsbFJlZGVlbUluZm9SZXNwb25zZRJACgtyZWRlZW1faW5mbxgBIAMoCzIZLnB5bG9ucy5weWxvbnMuUmVkZWVtSW5mb0IEyN4fAFIKcmVkZWVtSW5mbxJHCgpwYWdpbmF0aW9uGAIgASgLMicuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List queryGetPaymentInfoRequestDescriptor = $convert.base64Decode('ChpRdWVyeUdldFBheW1lbnRJbmZvUmVxdWVzdBIfCgtwdXJjaGFzZV9pZBgBIAEoCVIKcHVyY2hhc2VJZA==');
...
const QueryGetPaymentInfoResponse$json = const {
  ...
  '2': const [
    const {'1': 'payment_info', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.PaymentInfo', '8': const {}, '10': 'paymentInfo'},
  ],
};

/// Descriptor for `QueryGetPaymentInfoResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetPaymentInfoResponseDescriptor = $convert.base64Decode('ChtRdWVyeUdldFBheW1lbnRJbmZvUmVzcG9uc2USQwoMcGF5bWVudF9pbmZvGAEgASgLMhoucHlsb25zLnB5bG9ucy5QYXltZW50SW5mb0IEyN4fAFILcGF5bWVudEluZm8=');
...
const QueryAllPaymentInfoResponse$json = const {
  ...
  '2': const [
    const {'1': 'payment_info', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.PaymentInfo', '8': const {}, '10': 'paymentInfo'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryAllPaymentInfoResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryAllPaymentInfoResponseDescriptor = $convert.base64Decode('ChtRdWVyeUFsbFBheW1lbnRJbmZvUmVzcG9uc2USQwoMcGF5bWVudF9pbmZvGAEgAygLMhoucHlsb25zLnB5bG9ucy5QYXltZW50SW5mb0IEyN4fAFILcGF5bWVudEluZm8SRwoKcGFnaW5hdGlvbhgCIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
...
const QueryGetUsernameByAddressResponse$json = const {
  ...
  '2': const [
    const {'1': 'username', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.Username', '8': const {}, '10': 'username'},
  ],
};

/// Descriptor for `QueryGetUsernameByAddressResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetUsernameByAddressResponseDescriptor = $convert.base64Decode('CiFRdWVyeUdldFVzZXJuYW1lQnlBZGRyZXNzUmVzcG9uc2USOQoIdXNlcm5hbWUYASABKAsyFy5weWxvbnMucHlsb25zLlVzZXJuYW1lQgTI3h8AUgh1c2VybmFtZQ==');
...
const QueryGetAddressByUsernameResponse$json = const {
  ...
  '2': const [
    const {'1': 'address', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.AccountAddr', '8': const {}, '10': 'address'},
  ],
};

/// Descriptor for `QueryGetAddressByUsernameResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetAddressByUsernameResponseDescriptor = $convert.base64Decode('CiFRdWVyeUdldEFkZHJlc3NCeVVzZXJuYW1lUmVzcG9uc2USOgoHYWRkcmVzcxgBIAEoCzIaLnB5bG9ucy5weWxvbnMuQWNjb3VudEFkZHJCBMjeHwBSB2FkZHJlc3M=');
...
final $typed_data.Uint8List queryGetTradeRequestDescriptor = $convert.base64Decode('ChRRdWVyeUdldFRyYWRlUmVxdWVzdBIOCgJpZBgBIAEoBFICaWQ=');
@$core.Deprecated('Use queryGetTradeResponseDescriptor instead')
const QueryGetTradeResponse$json = const {
  '1': 'QueryGetTradeResponse',
  '2': const [
    const {'1': 'trade', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.Trade', '8': const {}, '10': 'trade'},
  ],
};

/// Descriptor for `QueryGetTradeResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetTradeResponseDescriptor = $convert.base64Decode('ChVRdWVyeUdldFRyYWRlUmVzcG9uc2USMAoFdHJhZGUYASABKAsyFC5weWxvbnMucHlsb25zLlRyYWRlQgTI3h8AUgV0cmFkZQ==');
...
const QueryListItemByOwnerResponse$json = const {
  ...
  '2': const [
    const {'1': 'items', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.Item', '8': const {}, '10': 'items'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
  '7': const {},
};
...
final $typed_data.Uint8List queryListItemByOwnerResponseDescriptor = $convert.base64Decode('ChxRdWVyeUxpc3RJdGVtQnlPd25lclJlc3BvbnNlEi8KBWl0ZW1zGAEgAygLMhMucHlsb25zLnB5bG9ucy5JdGVtQgTI3h8AUgVpdGVtcxJHCgpwYWdpbmF0aW9uGAIgASgLMicuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb246COigHwCIoB8A');
...
const QueryGetGoogleInAppPurchaseOrderRequest$json = const {
  ...
  '2': const [
    const {'1': 'purchase_token', '3': 1, '4': 1, '5': 9, '10': 'purchaseToken'},
  ],
};

/// Descriptor for `QueryGetGoogleInAppPurchaseOrderRequest`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetGoogleInAppPurchaseOrderRequestDescriptor = $convert.base64Decode('CidRdWVyeUdldEdvb2dsZUluQXBwUHVyY2hhc2VPcmRlclJlcXVlc3QSJQoOcHVyY2hhc2VfdG9rZW4YASABKAlSDXB1cmNoYXNlVG9rZW4=');
...
const QueryGetGoogleInAppPurchaseOrderResponse$json = const {
  ...
  '2': const [
    const {'1': 'order', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.GoogleInAppPurchaseOrder', '8': const {}, '10': 'order'},
  ],
};

/// Descriptor for `QueryGetGoogleInAppPurchaseOrderResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetGoogleInAppPurchaseOrderResponseDescriptor = $convert.base64Decode('CihRdWVyeUdldEdvb2dsZUluQXBwUHVyY2hhc2VPcmRlclJlc3BvbnNlEkMKBW9yZGVyGAEgASgLMicucHlsb25zLnB5bG9ucy5Hb29nbGVJbkFwcFB1cmNoYXNlT3JkZXJCBMjeHwBSBW9yZGVy');
...
final $typed_data.Uint8List queryListExecutionsByItemRequestDescriptor = $convert.base64Decode('CiBRdWVyeUxpc3RFeGVjdXRpb25zQnlJdGVtUmVxdWVzdBIfCgtjb29rYm9va19pZBgBIAEoCVIKY29va2Jvb2tJZBIXCgdpdGVtX2lkGAIgASgJUgZpdGVtSWQSRgoKcGFnaW5hdGlvbhgDIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb246COigHwCIoB8A');
...
const QueryListExecutionsByItemResponse$json = const {
  ...
  '2': const [
    const {'1': 'completed_executions', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.Execution', '8': const {}, '10': 'completedExecutions'},
    const {'1': 'pending_executions', '3': 2, '4': 3, '5': 11, '6': '.pylons.pylons.Execution', '8': const {}, '10': 'pendingExecutions'},
...
final $typed_data.Uint8List queryListExecutionsByItemResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List queryListExecutionsByRecipeRequestDescriptor = $convert.base64Decode('CiJRdWVyeUxpc3RFeGVjdXRpb25zQnlSZWNpcGVSZXF1ZXN0Eh8KC2Nvb2tib29rX2lkGAEgASgJUgpjb29rYm9va0lkEhsKCXJlY2lwZV9pZBgCIAEoCVIIcmVjaXBlSWQSRgoKcGFnaW5hdGlvbhgDIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb246COigHwCIoB8A');
...
final $typed_data.Uint8List queryListExecutionsByRecipeResponseDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List queryGetExecutionRequestDescriptor = $convert.base64Decode('ChhRdWVyeUdldEV4ZWN1dGlvblJlcXVlc3QSDgoCaWQYASABKAlSAmlk');
...
const QueryGetExecutionResponse$json = const {
  ...
  '2': const [
    const {'1': 'execution', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.Execution', '8': const {}, '10': 'execution'},
...
final $typed_data.Uint8List queryGetExecutionResponseDescriptor = $convert.base64Decode('ChlRdWVyeUdldEV4ZWN1dGlvblJlc3BvbnNlEjwKCWV4ZWN1dGlvbhgBIAEoCzIYLnB5bG9ucy5weWxvbnMuRXhlY3V0aW9uQgTI3h8AUglleGVjdXRpb24SHAoJY29tcGxldGVkGAIgASgIUgljb21wbGV0ZWQ=');
...
final $typed_data.Uint8List queryListRecipesByCookbookRequestDescriptor = $convert.base64Decode('CiFRdWVyeUxpc3RSZWNpcGVzQnlDb29rYm9va1JlcXVlc3QSHwoLY29va2Jvb2tfaWQYASABKAlSCmNvb2tib29rSWQSRgoKcGFnaW5hdGlvbhgCIAEoCzImLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlcXVlc3RSCnBhZ2luYXRpb24=');
...
const QueryListRecipesByCookbookResponse$json = const {
  ...
  '2': const [
    const {'1': 'recipes', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.Recipe', '8': const {}, '10': 'recipes'},
    const {'1': 'pagination', '3': 2, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryListRecipesByCookbookResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryListRecipesByCookbookResponseDescriptor = $convert.base64Decode('CiJRdWVyeUxpc3RSZWNpcGVzQnlDb29rYm9va1Jlc3BvbnNlEjUKB3JlY2lwZXMYASADKAsyFS5weWxvbnMucHlsb25zLlJlY2lwZUIEyN4fAFIHcmVjaXBlcxJHCgpwYWdpbmF0aW9uGAIgASgLMicuY29zbW9zLmJhc2UucXVlcnkudjFiZXRhMS5QYWdlUmVzcG9uc2VSCnBhZ2luYXRpb24=');
...
final $typed_data.Uint8List queryGetItemRequestDescriptor = $convert.base64Decode('ChNRdWVyeUdldEl0ZW1SZXF1ZXN0Eh8KC2Nvb2tib29rX2lkGAEgASgJUgpjb29rYm9va0lkEg4KAmlkGAMgASgJUgJpZA==');
@$core.Deprecated('Use queryGetItemResponseDescriptor instead')
const QueryGetItemResponse$json = const {
  '1': 'QueryGetItemResponse',
  '2': const [
    const {'1': 'item', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.Item', '8': const {}, '10': 'item'},
  ],
};

/// Descriptor for `QueryGetItemResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetItemResponseDescriptor = $convert.base64Decode('ChRRdWVyeUdldEl0ZW1SZXNwb25zZRItCgRpdGVtGAEgASgLMhMucHlsb25zLnB5bG9ucy5JdGVtQgTI3h8AUgRpdGVt');
...
final $typed_data.Uint8List queryGetRecipeRequestDescriptor = $convert.base64Decode('ChVRdWVyeUdldFJlY2lwZVJlcXVlc3QSHwoLY29va2Jvb2tfaWQYASABKAlSCmNvb2tib29rSWQSDgoCaWQYAiABKAlSAmlk');
...
const QueryGetRecipeResponse$json = const {
  ...
  '2': const [
    const {'1': 'recipe', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.Recipe', '8': const {}, '10': 'recipe'},
  ],
};

/// Descriptor for `QueryGetRecipeResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetRecipeResponseDescriptor = $convert.base64Decode('ChZRdWVyeUdldFJlY2lwZVJlc3BvbnNlEjMKBnJlY2lwZRgBIAEoCzIVLnB5bG9ucy5weWxvbnMuUmVjaXBlQgTI3h8AUgZyZWNpcGU=');
...
const QueryListCookbooksByCreatorResponse$json = const {
  ...
  '2': const [
    const {'1': 'cookbooks', '3': 1, '4': 3, '5': 11, '6': '.pylons.pylons.Cookbook', '8': const {}, '10': 'cookbooks'},
    const {'1': 'pagination', '3': 3, '4': 1, '5': 11, '6': '.cosmos.base.query.v1beta1.PageResponse', '10': 'pagination'},
  ],
};

/// Descriptor for `QueryListCookbooksByCreatorResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryListCookbooksByCreatorResponseDescriptor = $convert.base64Decode('CiNRdWVyeUxpc3RDb29rYm9va3NCeUNyZWF0b3JSZXNwb25zZRI7Cgljb29rYm9va3MYASADKAsyFy5weWxvbnMucHlsb25zLkNvb2tib29rQgTI3h8AUgljb29rYm9va3MSRwoKcGFnaW5hdGlvbhgDIAEoCzInLmNvc21vcy5iYXNlLnF1ZXJ5LnYxYmV0YTEuUGFnZVJlc3BvbnNlUgpwYWdpbmF0aW9u');
...
final $typed_data.Uint8List queryGetCookbookRequestDescriptor = $convert.base64Decode('ChdRdWVyeUdldENvb2tib29rUmVxdWVzdBIOCgJpZBgBIAEoCVICaWQ=');
...
const QueryGetCookbookResponse$json = const {
  ...
  '2': const [
    const {'1': 'cookbook', '3': 1, '4': 1, '5': 11, '6': '.pylons.pylons.Cookbook', '8': const {}, '10': 'cookbook'},
  ],
};

/// Descriptor for `QueryGetCookbookResponse`. Decode as a `google.protobuf.DescriptorProto`.
final $typed_data.Uint8List queryGetCookbookResponseDescriptor = $convert.base64Decode('ChhRdWVyeUdldENvb2tib29rUmVzcG9uc2USOQoIY29va2Jvb2sYASABKAsyFy5weWxvbnMucHlsb25zLkNvb2tib29rQgTI3h8AUghjb29rYm9vaw==');
