...
const Request$json = const {
  ...
  '2': const [
    ...
    const {'1': 'init_chain', '3': 4, '4': 1, '5': 11, '6': '.tendermint.abci.RequestInitChain', '9': 0, '10': 'initChain'},
    const {'1': 'query', '3': 5, '4': 1, '5': 11, '6': '.tendermint.abci.RequestQuery', '9': 0, '10': 'query'},
    const {'1': 'begin_block', '3': 6, '4': 1, '5': 11, '6': '.tendermint.abci.RequestBeginBlock', '9': 0, '10': 'beginBlock'},
    const {'1': 'check_tx', '3': 7, '4': 1, '5': 11, '6': '.tendermint.abci.RequestCheckTx', '9': 0, '10': 'checkTx'},
    const {'1': 'deliver_tx', '3': 8, '4': 1, '5': 11, '6': '.tendermint.abci.RequestDeliverTx', '9': 0, '10': 'deliverTx'},
    const {'1': 'end_block', '3': 9, '4': 1, '5': 11, '6': '.tendermint.abci.RequestEndBlock', '9': 0, '10': 'endBlock'},
    const {'1': 'commit', '3': 10, '4': 1, '5': 11, '6': '.tendermint.abci.RequestCommit', '9': 0, '10': 'commit'},
    const {'1': 'list_snapshots', '3': 11, '4': 1, '5': 11, '6': '.tendermint.abci.RequestListSnapshots', '9': 0, '10': 'listSnapshots'},
    const {'1': 'offer_snapshot', '3': 12, '4': 1, '5': 11, '6': '.tendermint.abci.RequestOfferSnapshot', '9': 0, '10': 'offerSnapshot'},
    const {'1': 'load_snapshot_chunk', '3': 13, '4': 1, '5': 11, '6': '.tendermint.abci.RequestLoadSnapshotChunk', '9': 0, '10': 'loadSnapshotChunk'},
    const {'1': 'apply_snapshot_chunk', '3': 14, '4': 1, '5': 11, '6': '.tendermint.abci.RequestApplySnapshotChunk', '9': 0, '10': 'applySnapshotChunk'},
  ],
  '8': const [
    const {'1': 'value'},
  ],
...
final $typed_data.Uint8List requestDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List requestInfoDescriptor = $convert.base64Decode('CgtSZXF1ZXN0SW5mbxIYCgd2ZXJzaW9uGAEgASgJUgd2ZXJzaW9uEiMKDWJsb2NrX3ZlcnNpb24YAiABKARSDGJsb2NrVmVyc2lvbhIfCgtwMnBfdmVyc2lvbhgDIAEoBFIKcDJwVmVyc2lvbhIhCgxhYmNpX3ZlcnNpb24YBCABKAlSC2FiY2lWZXJzaW9u');
...
const RequestInitChain$json = const {
  ...
  '2': const [
    ...
    const {'1': 'consensus_params', '3': 3, '4': 1, '5': 11, '6': '.tendermint.types.ConsensusParams', '10': 'consensusParams'},
...
final $typed_data.Uint8List requestInitChainDescriptor = $convert.base64Decode('');
...
const Response$json = const {
  ...
  '2': const [
    ...
    const {'1': 'init_chain', '3': 5, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseInitChain', '9': 0, '10': 'initChain'},
    const {'1': 'query', '3': 6, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseQuery', '9': 0, '10': 'query'},
    const {'1': 'begin_block', '3': 7, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseBeginBlock', '9': 0, '10': 'beginBlock'},
    const {'1': 'check_tx', '3': 8, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseCheckTx', '9': 0, '10': 'checkTx'},
    const {'1': 'deliver_tx', '3': 9, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseDeliverTx', '9': 0, '10': 'deliverTx'},
    const {'1': 'end_block', '3': 10, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseEndBlock', '9': 0, '10': 'endBlock'},
    const {'1': 'commit', '3': 11, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseCommit', '9': 0, '10': 'commit'},
    const {'1': 'list_snapshots', '3': 12, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseListSnapshots', '9': 0, '10': 'listSnapshots'},
    const {'1': 'offer_snapshot', '3': 13, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseOfferSnapshot', '9': 0, '10': 'offerSnapshot'},
    const {'1': 'load_snapshot_chunk', '3': 14, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseLoadSnapshotChunk', '9': 0, '10': 'loadSnapshotChunk'},
    const {'1': 'apply_snapshot_chunk', '3': 15, '4': 1, '5': 11, '6': '.tendermint.abci.ResponseApplySnapshotChunk', '9': 0, '10': 'applySnapshotChunk'},
  ],
  '8': const [
    const {'1': 'value'},
  ],
...
final $typed_data.Uint8List responseDescriptor = $convert.base64Decode('');
...
const ResponseInitChain$json = const {
  '1': 'ResponseInitChain',
  '2': const [
    const {'1': 'consensus_params', '3': 1, '4': 1, '5': 11, '6': '.tendermint.types.ConsensusParams', '10': 'consensusParams'},
...
final $typed_data.Uint8List responseInitChainDescriptor = $convert.base64Decode('');
...
const ResponseEndBlock$json = const {
  ...
  '2': const [
    ...
    const {'1': 'consensus_param_updates', '3': 2, '4': 1, '5': 11, '6': '.tendermint.types.ConsensusParams', '10': 'consensusParamUpdates'},
...
final $typed_data.Uint8List responseEndBlockDescriptor = $convert.base64Decode('');
...
final $typed_data.Uint8List eventAttributeDescriptor = $convert.base64Decode('Cg5FdmVudEF0dHJpYnV0ZRIQCgNrZXkYASABKAlSA2tleRIUCgV2YWx1ZRgCIAEoCVIFdmFsdWUSFAoFaW5kZXgYAyABKAhSBWluZGV4');
...
final $typed_data.Uint8List aBCIApplicationServiceDescriptor = $convert.base64Decode('');
