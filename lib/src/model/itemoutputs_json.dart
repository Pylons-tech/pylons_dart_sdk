import 'package:pylons_sdk/src/model/coins_json.dart';
import 'package:pylons_sdk/src/model/doubles_json.dart';
import 'package:pylons_sdk/src/model/longs_json.dart';
import 'package:pylons_sdk/src/model/strings_json.dart';
...
class ItemOutputs {
  ...
  ItemOutputs.fromJson(dynamic json) {
    ...
    if (json['mutableStrings'] != null) {
      ...
      //   // mutableStringConst.add(dynamic.fromJson(v));
      // }
