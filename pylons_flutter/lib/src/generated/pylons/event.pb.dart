...
class EventUpdateCookbook extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventUpdateCookbook', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ..aOM<$3.Cookbook>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalCookbook', protoName: 'originalCookbook', subBuilder: $3.Cookbook.create)
    ..hasRequiredFields = false
  ;

  EventUpdateCookbook._() : super();
  factory EventUpdateCookbook({
    $3.Cookbook? originalCookbook,
  }) {
    final _result = create();
  ...
  @$pb.TagNumber(1)
  $3.Cookbook get originalCookbook => $_getN(0);
  @$pb.TagNumber(1)
  set originalCookbook($3.Cookbook v) { setField(1, v); }
  @$pb.TagNumber(1)
  $core.bool hasOriginalCookbook() => $_has(0);
  @$pb.TagNumber(1)
  void clearOriginalCookbook() => clearField(1);
  @$pb.TagNumber(1)
  $3.Cookbook ensureOriginalCookbook() => $_ensure(0);
}
...
class EventUpdateRecipe extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventUpdateRecipe', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ..aOM<$2.Recipe>(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalRecipe', protoName: 'originalRecipe', subBuilder: $2.Recipe.create)
    ..hasRequiredFields = false
  ;
  ...
  @$pb.TagNumber(1)
  set originalRecipe($2.Recipe v) { setField(1, v); }
  @$pb.TagNumber(1)
...
class EventCompleteExecution extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventCompleteExecution', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ..aOS(1, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'creator')
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ID', protoName: 'ID')
    ..pc<$0.Coin>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'burnCoins', $pb.PbFieldType.PM, protoName: 'burnCoins', subBuilder: $0.Coin.create)
    ..pc<$0.Coin>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'payCoins', $pb.PbFieldType.PM, protoName: 'payCoins', subBuilder: $0.Coin.create)
    ..pc<$0.Coin>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'transferCoins', $pb.PbFieldType.PM, protoName: 'transferCoins', subBuilder: $0.Coin.create)
    ..pc<$0.Coin>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'feeCoins', $pb.PbFieldType.PM, protoName: 'feeCoins', subBuilder: $0.Coin.create)
    ..pc<$0.Coin>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coinOutputs', $pb.PbFieldType.PM, protoName: 'coinOutputs', subBuilder: $0.Coin.create)
    ..pc<$1.Item>(8, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'mintItems', $pb.PbFieldType.PM, protoName: 'mintItems', subBuilder: $1.Item.create)
    ..pc<$1.Item>(9, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'modifyItems', $pb.PbFieldType.PM, protoName: 'modifyItems', subBuilder: $1.Item.create)
    ..hasRequiredFields = false
  ;
...
class EventSetItemString extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventSetItemString', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ...
    ..aOS(2, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'CookbookID', protoName: 'CookbookID')
    ..aOS(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'ID', protoName: 'ID')
    ..pc<$1.StringKeyValue>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'originalMutableStrings', $pb.PbFieldType.PM, protoName: 'originalMutableStrings', subBuilder: $1.StringKeyValue.create)
    ..hasRequiredFields = false
  ;
...
class EventFulfillTrade extends $pb.GeneratedMessage {
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'EventFulfillTrade', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'Pylonstech.pylons.pylons'), createEmptyInstance: create)
    ...
    ..pc<$4.ItemRef>(4, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemInputs', $pb.PbFieldType.PM, protoName: 'itemInputs', subBuilder: $4.ItemRef.create)
    ..pc<$0.Coin>(5, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coinInputs', $pb.PbFieldType.PM, protoName: 'coinInputs', subBuilder: $0.Coin.create)
    ..pc<$4.ItemRef>(6, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'itemOutputs', $pb.PbFieldType.PM, protoName: 'itemOutputs', subBuilder: $4.ItemRef.create)
    ..pc<$0.Coin>(7, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'coinOutputs', $pb.PbFieldType.PM, protoName: 'coinOutputs', subBuilder: $0.Coin.create)
    ..hasRequiredFields = false
  ;
  ...
  factory EventFulfillTrade({
    ...
    $core.Iterable<$4.ItemRef>? itemInputs,
  ...
  @$pb.TagNumber(4)
  $core.List<$4.ItemRef> get itemInputs => $_getList(3);

  @$pb.TagNumber(5)
  $core.List<$0.Coin> get coinInputs => $_getList(4);

  @$pb.TagNumber(6)
  $core.List<$4.ItemRef> get itemOutputs => $_getList(5);
