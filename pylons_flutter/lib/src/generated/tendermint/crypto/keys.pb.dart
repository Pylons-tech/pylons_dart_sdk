...
class PublicKey extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'PublicKey', package: const $pb.PackageName(const $core.bool.fromEnvironment('protobuf.omit_message_names') ? '' : 'tendermint.crypto'), createEmptyInstance: create)
    ...
    ..a<$core.List<$core.int>>(3, const $core.bool.fromEnvironment('protobuf.omit_field_names') ? '' : 'sr25519', $pb.PbFieldType.OY)
  ...
  @$pb.TagNumber(3)
  $core.List<$core.int> get sr25519 => $_getN(2);
  @$pb.TagNumber(3)
  set sr25519($core.List<$core.int> v) { $_setBytes(2, v); }
  @$pb.TagNumber(3)
  $core.bool hasSr25519() => $_has(2);
  @$pb.TagNumber(3)
  void clearSr25519() => clearField(3);
}
