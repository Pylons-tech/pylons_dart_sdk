...
abstract class ABCIApplicationServiceBase extends $pb.GeneratedService {
  ...
  $async.Future<$pb.GeneratedMessage> handleCall($pb.ServerContext ctx, $core.String method, $pb.GeneratedMessage request) {
    switch (method) {
      case 'Echo': return this.echo(ctx, request as $7.RequestEcho);
      case 'Flush': return this.flush(ctx, request as $7.RequestFlush);
      case 'Info': return this.info(ctx, request as $7.RequestInfo);
      case 'DeliverTx': return this.deliverTx(ctx, request as $7.RequestDeliverTx);
      case 'CheckTx': return this.checkTx(ctx, request as $7.RequestCheckTx);
      case 'Query': return this.query(ctx, request as $7.RequestQuery);
      case 'Commit': return this.commit(ctx, request as $7.RequestCommit);
      case 'InitChain': return this.initChain(ctx, request as $7.RequestInitChain);
      case 'BeginBlock': return this.beginBlock(ctx, request as $7.RequestBeginBlock);
      case 'EndBlock': return this.endBlock(ctx, request as $7.RequestEndBlock);
      case 'ListSnapshots': return this.listSnapshots(ctx, request as $7.RequestListSnapshots);
      case 'OfferSnapshot': return this.offerSnapshot(ctx, request as $7.RequestOfferSnapshot);
      case 'LoadSnapshotChunk': return this.loadSnapshotChunk(ctx, request as $7.RequestLoadSnapshotChunk);
      case 'ApplySnapshotChunk': return this.applySnapshotChunk(ctx, request as $7.RequestApplySnapshotChunk);
      default: throw $core.ArgumentError('Unknown method: $method');
    }
  }
