...
import 'package:pylons_flutter/features/data/models/transaction.dart';
import 'package:pylons_flutter/features/data/models/wallet_model.dart';



//All communication with SDK must go with [Pylons] as this will be core point of communication other dev with SDK
class Pylons {

  /// Retrieves the [WalletModel] instance. Since [WalletModel] is a
  /// singleton, this method will always return a reference to the same object.
  static WalletModel walletFromKey({required String privateKey}) =>
      WalletModel.fromKey(privateKey: privateKey);

  static WalletModel walletFromMnemonic({required String mnemonic}) =>
      WalletModel.derive(mnemonic: mnemonic);
  ...
  /// this library.
  static Future<List<Cookbook>> getCookbooks() async{
  ...
  static Future<Profile> getProfile(String? address) async{
    throw UnimplementedError();
  }
  ...
  /// only be passed in the result of faulty behavior on the part of
  /// this library.
  static Future<List<Recipe>> getRecipes(String? address) {
    throw UnimplementedError();
  }
  ...
  /// only be passed in the result of faulty behavior on the part of
  /// this library.
  static Future<List<Trade>> getTrades() {
    throw UnimplementedError();
  }
