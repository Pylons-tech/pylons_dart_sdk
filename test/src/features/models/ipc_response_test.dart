...
void main() {
  test('should give success response for the encoded message', () {
    ...
    expect(
        'SDKIPCResponse{success: true, errorCode: , error: , data: $MOCK_USERNAME, action: ${StringConst.GET_PROFILE}}',
        sdkMessage.toString());
  });
  ...
  test('should give error response for the encoded message', () {
    ...
    expect(
        'SDKIPCResponse{success: false, errorCode: somethingWentWrong, error: Wallet doesn\'t exists, data: , action: ${StringConst.GET_PROFILE}}',
        sdkMessage.toString());
  });
}
