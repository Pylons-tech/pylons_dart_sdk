...
void main() {
  test('should give SDKIPCMessage from Json', () {
    const message = 'ewoJImFjdGlvbiI6ICJnZXRQcm9maWxlIiwKCSJqc29uIjogIkphd2FkIiwKCSJzZW5kZXIiOiAiZXhhbXBsZSIKfQ==';
    ...
    expect('SDKIPCMessage{action: ${Strings.GET_PROFILE}, json: $MOCK_USERNAME, sender: $MOCK_HOST}', sdkMessage.toString());
  });
}
