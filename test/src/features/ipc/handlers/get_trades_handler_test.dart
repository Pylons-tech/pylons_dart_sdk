...
void main() {
  test('should complete the get trades future', () {
    initResponseCompleter(StringConst.GET_TRADES);
    ...
    expect(true, responseCompleters[StringConst.GET_TRADES]!.isCompleted);
  });
  ...
  test('should complete the get trades future with data ', () async {
    ...
    var response = await responseCompleters[StringConst.GET_TRADES]!.future;
  ...
  test('should complete the get trades future with error ', () async {
    ...
    expect(StringConst.ERR_MALFORMED_TRADES, response.errorCode);
  });
}
