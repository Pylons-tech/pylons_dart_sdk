...
void main() {
  test('should complete the get  recipe future', () {
    initResponseCompleter(StringConst.GET_RECIPE);
    ...
    expect(true, responseCompleters[StringConst.GET_RECIPE]!.isCompleted);
  });
  ...
  test('should complete the get  recipe future with data ', () async {
    ...
    var response = await responseCompleters[StringConst.GET_RECIPE]!.future;
  ...
  test('should complete the get  recipe future with error ', () async {
    ...
    expect(StringConst.ERR_MALFORMED_RECIPE, response.errorCode);
  });
}
